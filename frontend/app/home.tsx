...
export default function home() {
  ...
  <StatusBar
  backgroundColor="#1d78ef" // Example: a dark blue color (Android only)
  barStyle="light-content" // Makes the text and icons light for better visibility on a dark background
/>
...
<TouchableOpacity style={styles.BttnGo} onPress={() =>  router.push("/artist")}>
